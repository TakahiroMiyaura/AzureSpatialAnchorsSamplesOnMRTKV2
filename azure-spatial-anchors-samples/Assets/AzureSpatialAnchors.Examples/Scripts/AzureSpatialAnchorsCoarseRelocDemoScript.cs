...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public class AzureSpatialAnchorsCoarseRelocDemoScript : DemoScriptBase
    {
        ...
        private AppState _currentAppState = AppState.DemoStepSensorSettings;
        ...
        public async override Task AdvanceDemoAsync()
        {
            ...
            {
                case AppState.DemoStepSensorSettings:
                    currentAppState = AppState.DemoStepCreateSession;
                    SensorSettings.Instance.Contents.SetActive(false);
                    break;
